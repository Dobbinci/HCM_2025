...
public class StudentController {
    ...
    public void enrollCourse(int index) {
        ...
        EnrolledCourse enrolledCourse = EnrolledCourse.builder()
                .student(memberRepo.findById(10L)) // 예시로 1L을 사용, 실제로는 학생 ID를 받아와야 함
                .course(course)
                .build();
    ...
    public List<EnrolledCourseDTO> loadEnrolledCourseList() {
        ...
        List<EnrolledCourse> enrolledCourses = enrolledCourseRepo.findByStudentId(10L); // 예시로 1L을 사용, 실제로는 학생 ID를 받아와야 함
