...
public class SocialSignUpView implements SignUpViewStrategy {
    ...
    public void signup() {
        ...
        String memberId = "", socialId = "", socialPassword = "", name = "", position = "";
        ...
        socialPassword = scanner.nextLine();

        memberControllerFacade.saveMember(memberId, name, socialId, socialPassword, position, true);
    }
}
